...
# category in categories and yAxis.

def drawLineGraph(data, yAxis='week', categories=['data'], numWeeks=13, xLabel='week', yLabel='y-axis', \
    title='title', outputFile='output.png'):
    ...
    for rank, column in enumerate(categories):
        ...
        y_pos = data[column_rec_name][-1] - 0.5
        ...
        # by the viewer.
        plt.text(numWeeks+.5, y_pos, column, fontsize=14, color=color_sequence[rank])
